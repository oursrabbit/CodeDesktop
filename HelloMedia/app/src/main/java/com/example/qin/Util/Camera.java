...
import com.example.qin.Custom.UI.AutoFitTextureView;
import com.example.qin.ScannerActivity;
        ...
        try {
            ...
            for (String cameraID : manager.getCameraIdList()) {
                ...
                if (characteristics.get(CameraCharacteristics.LENS_FACING) == CameraCharacteristics.LENS_FACING_FRONT) {
                    ...
                    if (this.host.checkSelfPermission(Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                        updateInfoLabel("相机权限未开启，无法签到");
                        stopRunning();
                        Uri packageURI=Uri.parse("package:" + "com.example.qin");
